...
//    @Autowired
//    private LegalCustomerDetails legalCustomerDetails;
//
////    @Autowired
...
//
//        http.addFilterBefore(new JwtTokenFilter(legalCustomerDetails), UsernamePasswordAuthenticationFilter.class);
//    }
//
//    @Bean
//    @Override
